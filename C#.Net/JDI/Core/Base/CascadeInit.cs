...
namespace Epam.JDI.Core.Base
{
    public abstract class CascadeInit
    {
        ...
        protected IBaseElement GetInstanceElement(object parent, Type type, Type parentType, FieldInfo field, string driverName)
        {
        ...
        private IBaseElement CreateChildFromFieldStatic(object parent, Type parentClass, FieldInfo field, Type type, string driverName)
        {
            var instance = (IBaseElement)field.GetValue(parent);
            if (instance == null)
