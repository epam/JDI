...
import com.epam.jdi.uitests.win.winium.elements.composite.Pagination;
...
import static com.epam.jdi.uitests.testing.unittests.pageobjects.EpamJDIApplication.simpleTablePage;
...
public class PaginationTests extends InitTests {
    ...
    boolean urlContains(CharSequence s){
        return WinSettings.getDriver().getCurrentUrl().contains(s);
    }
