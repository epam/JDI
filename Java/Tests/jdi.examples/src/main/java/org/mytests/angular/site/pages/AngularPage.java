...
import org.mytests.angular.site.CustomElements.Slider;
...
public class AngularPage extends WebPage {
    ...
    public Slider specialOptions = new Slider("special");

    /*
    @FindBy(css = "[name=tos] .md-container")
    public CheckBox acceptTerms = new CheckBox() {
        @Override
        protected boolean isCheckedAction() {
            return $("[name=tos]").attr("aria-checked").equals("true");
        }
    };*/
}
