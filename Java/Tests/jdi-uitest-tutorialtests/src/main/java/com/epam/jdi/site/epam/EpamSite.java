...
import com.epam.jdi.site.epam.sections.AcceptCookiePopup;
...
public class EpamSite extends WebSite {
  ...
  @JPage(
      url =
          "/careers/job-listings?query=Test+Automation+Engineer+(back-end)&country=Russia&city=St-Petersburg&department=Software+Test+Engineering",
      urlTemplate = ".*/careers/job-listings.*",
      title = "Job Listings",
      urlCheckType = MATCH,
  ...
  @JPage(
      url = "/careers/job-listings/job.11516",
      urlTemplate = ".*/careers/job-listings/job\\.\\d*",
      urlCheckType = MATCH)
  ...
  @JMenu(
      level1 = @JFindBy(css = "ul.top-navigation__row>li span a"),
      level2 = @JFindBy(css = "ul.top-navigation__grand-sub-list>li a"))
  public static Menu multipleHeaderMenu;

  @Css(".cookie-disclaimer-ui")
  public static AcceptCookiePopup acceptCookiePopup;

  @FindBy(css = ".tile-menu .submenu a")
  public static Menu<HeaderSolutionsMenu> headerSolutionsMenu =
      new Menu<HeaderSolutionsMenu>() {
