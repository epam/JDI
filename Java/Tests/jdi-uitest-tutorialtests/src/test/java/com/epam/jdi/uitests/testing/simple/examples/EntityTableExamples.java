...
public class EntityTableExamples extends TestsBase {
    private EntityTable<Vacancy, JobRecord> jobsTable() {
    ...
    public void before(Method method) {
        ...
        Assert.isFalse(jobListingPage.jobsAsData::isEmpty);
    }
    @Test
    ...
    public void findEntity() {
        ...
        Assert.entitiesAreEquals(vacancy, new Vacancy("Test Automation Engineer (back-end)", "Software Test Engineering", "St-Petersburg, Russia"));
    }
    //@Test
