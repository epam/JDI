...
public class TableProvider {
    private Function<ITable, ITable> tableFunc;
    ...
    public TableProvider(String name, Function<ITable, ITable> tableFunc) {
        this.name = name;
        this.tableFunc = tableFunc;
        table = supportPage.supportTable;
    }
    public TableProvider(String name, ITable table, Function<ITable, ITable> tableFunc) {
        this.name = name;
        this.tableFunc = tableFunc;
        this.table = table;
    }

    public TableProvider(String name, ITable table, Function<ITable, ITable> tableFunc, Function<DynamicTablePage, Boolean> pageFunc, DynamicTablePage page){
        this.name = name;
        this.table = table;
        this.tableFunc = tableFunc;
    ...
    public TableProvider(String name, ITable table, Function<ITable, ITable> tableFunc, Function<SortingTablePage, SortingTablePage> pageFunc, SortingTablePage page){
        this.name = name;
        this.table = table;
        this.tableFunc = tableFunc;
