package com.epam.jdi.uitests.win.winium.elements.apiInteract;
/*
...
import static com.epam.jdi.uitests.win.winium.driver.WebDriverByUtils.*;
import static com.epam.jdi.uitests.win.settings.WinSettings.getDriverFactory;
...
public class GetElementModule implements IAvatar {
    ...
    private SearchContext getSearchContext(Object element) {
        ...
        SearchContext searchContext = containsRoot(locator)
                ? getDriver()
                : getSearchContext(bElement.getParent());
