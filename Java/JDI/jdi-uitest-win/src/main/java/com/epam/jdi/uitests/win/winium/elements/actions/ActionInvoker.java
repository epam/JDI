...
public class ActionInvoker {
    ...
    public final <TResult> TResult doJActionResult(String actionName, Supplier<TResult> action,
        ...
        try {
            processDemoMode();
            return BaseElement.actionScenrios.setElement(element).resultScenario(actionName, action, logResult, level);
    ...
    public final void doJAction(String actionName, JAction action, LogLevels level) {
        Timer.alwaysDoneAction(() -> {
            processDemoMode();
            BaseElement.actionScenrios.setElement(element).actionScenario(actionName, action, level);
        });
    }
