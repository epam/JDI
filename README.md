...
JDI – is the test Framework for UI automation testing. It extends the Page Objects design pattern and introduce a lot of additional elements with implementation of its common usages.

Framework use concept “Easy things should be easy, and hard things should be possible” Larry Wall (c).
