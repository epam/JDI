    ...
    private String registerLocalDriver(DriverTypes driverType) {
        ...
        switch (driverType) {
            case CHROME:
                ...
                return registerDriver(driverType, ChromeDriver::new);
            case FIREFOX:
                return registerDriver(driverType, FirefoxDriver::new);
            case IE:
                ...
                return registerDriver(driverType, () -> new InternetExplorerDriver(capabilities));
        }
        throw exception("Unknown driver: " + driverType);
    }
