package com.epam.jdi.web.matcher.base;
/*
...
import com.epam.jdi.commons.linqinterfaces.JAction;
import com.epam.jdi.commons.linqinterfaces.JFuncREx;
import com.epam.jdi.commons.map.MapArray;
...
import static com.epam.jdi.commons.PrintUtils.print;
import static com.epam.jdi.commons.ReflectionUtils.isInterface;
import static com.epam.jdi.web.matcher.base.DoScreen.NO_SCREEN;
import static com.epam.jdi.web.matcher.base.PrintUtils.objToSetValue;
import static com.epam.jdi.web.matcher.base.PrintUtils.printObjectAsArray;
...
public abstract class BaseMatcher implements IAsserter, IChecker {
    ...
    public void matches(String actual, String expected) {
        matches(actual, expected, null);
    }
