...
public final class PrintUtils {
    ...
    public static <T> String print(Map<String, T> map, String separator, String format) {
        return print(LinqUtils.toList(map, (k, v) -> MessageFormat.format(format, k, v)), separator, "%s");
    }
    ...
    public static String printFields(Object obj, String separator) {
        ...
        String params = print(LinqUtils.select(ReflectionUtils.getFields(obj, String.class),
                field -> String.format("%s: '%s'", field.getName(), ReflectionUtils.getValueField(field, obj))), separator, "%s");
